...
export default function PatternsPage({ onOpenDetail }) {
  return (
    <Flex direction="column" gap="6">
      ...
      <Grid columns="3" gap="6">
        <Card style={{ padding: '24px' }}>
          ...
          <Flex align="center" gap="1">
            <TrendingUpIcon style={{ width: 16, height: 16, color: 'var(--blue-10)' }} />
      ...
      <Flex direction="column" gap="6">
        <DiscoveryCard
          title={<><LightbulbIcon style={{ width: 18, height: 18, marginRight: '6px', verticalAlign: 'text-bottom' }} />Tuesday 2-4 PM Toll Cost Spike: Port Schedule Correlation</>}
          description="Every Tuesday, toll costs spike 47% between 2:00-4:00 PM compared to same time slot Monday/Wednesday/Thursday/Friday. Pattern hidden in aggregate monthly reports for 18 months—AI correlation analysis cross-referenced timestamps with external data and identified root cause: Port of Oakland container ship schedule. Container ships dock Tuesday mornings (avg arrival 8:47 AM), containers cleared by 2 PM, creating surge of 23 delivery vehicles rushing to meet same-day delivery commitments via I-880 toll corridors ($8.50/trip vs $2.10 off-peak). Affected routes: Oakland Port to San Jose (17 vehicles), Oakland Port to Fremont (6 vehicles). Tuesday avg toll cost: $1,847 vs non-Tuesday avg: $1,256 (47% premium = $591/week excess = $30,732 annual waste). Root cause identified: All affected delivery commitments have Tuesday 6 PM deadline regardless of ship arrival time. Recommendation: Negotiate delivery deadline flexibility—if ship arrives Tuesday 9 AM, allow Wednesday delivery to avoid toll surge pricing and congestion. Port publishes ship schedule 72 hours advance—implement dynamic scheduling. Expected savings: $30,732 annually with zero operational impact (customers flexible on 24-hour delivery window)."
        ...
        <DiscoveryCard
          ...
          onOpenDetail={onOpenDetail}
          insightId="end-of-month-surge"
        />

        <DiscoveryCard
          title={<><LightbulbIcon style={{ width: 18, height: 18, marginRight: '6px', verticalAlign: 'text-bottom' }} />Rainy Day Toll Surge: Highway Preference During Precipitation</>}
          description="Toll road usage increases 28% on days with measurable precipitation (≥0.1 inches rain) compared to dry days, with proportional 28% cost increase. AI cross-referenced 14 months of toll data with NOAA weather station data (Oakland Int'l Airport station KOAK). Analysis: 127 rainy days in dataset showed avg daily toll cost $1,847 vs 301 dry days avg $1,443 (28% premium). Root cause identified through GPS route analysis: During rain, drivers default to highway/toll routes (I-880, I-580, Bay Bridge) instead of surface street alternatives to avoid perceived safety risk from slick roads, traffic lights, pedestrian crossings. Behavioral pattern: Rain triggers automatic GPS re-routing using fastest-route mode which prioritizes highways. Reality: Time savings minimal (avg 3.2 minutes faster) but cost significant ($12.40 avg per rainy-day trip vs $8.20 dry-day trip = $4.20 premium per trip). Annual impact: Based on Bay Area avg 67 rain days/year × avg 23 vehicles running routes on rainy days × avg 4 trips/vehicle/day × $4.20 premium = $25,942 annual weather-driven excess toll costs. Recommendation: Update GPS routing profiles with weather-aware economical routing that uses surface streets during rain unless time savings exceeds 10 minutes. Drivers trained that surface streets are safe in rain at reduced speeds. Expected savings: $18,159 annually (70% of excess preserved for safety, 30% recovered through smarter routing)."
        ...
        <DiscoveryCard
          ...
          chartYAxis="$18,723"
          onOpenDetail={onOpenDetail}
          insightId="high-concentration-routes"
        />

        <DiscoveryCard
          title={<><LightbulbIcon style={{ width: 18, height: 18, marginRight: '6px', verticalAlign: 'text-bottom' }} />New Driver Toll Cost Premium: Experience Learning Curve Pattern</>}
          description="Drivers with <6 months tenure have 3.2x higher toll costs per delivery compared to drivers with >18 months experience—clear learning curve pattern indicating training gap. Analysis of 67 active drivers over 18-month period: New drivers (0-6 months tenure, n=23): Avg $8.47 toll cost per delivery. Experienced drivers (>18 months tenure, n=31): Avg $2.64 toll cost per delivery. 3.2x cost premium for new drivers. Root cause deep-dive via GPS route analysis and driver interviews revealed: (1) New drivers unfamiliar with toll-free alternative routes—default to GPS 'fastest route' which uses toll roads. (2) GPS doesn't factor toll costs into routing, only time. (3) Experienced drivers learned toll-free alternatives through trial-and-error over months. (4) No formal route training program exists—drivers learn organically. (5) New drivers don't realize many toll routes save only 2-4 minutes vs free alternatives. Example comparison: New driver Sarah Chen (hired June 2024, 4 months tenure): Oakland to Fremont delivery via I-880 toll road ($11.15 toll, 28 minutes). Veteran driver Michael Torres (5 years tenure): Same route via Mission Blvd/Fremont Blvd toll-free (0 toll, 32 minutes)—saves $11.15 for 4-minute time penalty. Annual impact calculation: 23 new drivers × avg 47 deliveries/week × ($8.47 - $2.64 premium) = $276,342 annual excess toll costs from undertrained new drivers. Recommendation: Implement 2-hour 'Route Economics Training' workshop during onboarding showing toll vs toll-free options for every service route with time/cost tradeoffs. Provide route guide reference cards. Expected outcome: Reduce new driver toll premium from 3.2x to 1.4x within 3 months of implementation (60% improvement) = $165,805 annual savings. Faster driver profitability ramp."
